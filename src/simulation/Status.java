...
public enum Status {COMP, WMATL, CUSREC, RDIRWO, REVIEW, DISPTCHD, OPSCOMP, WOTHERS, WLABR, PLANINPR, RTS, WASSIGN, SCHD, WPLAN, MTRECL,
	...
	WMATLRVW,WMATLPICK, MATLSENT,WIVGT,FLDCOMP,MATLREADY,PLANINPRG,NOACCESS,WCONTR,ASSIGNED,WOTHRS,NEEDRVW,WMOC,A,B//TODO name this Status
}

/*
Value	Description
A		Reserve for new Status
B		Reserve for new Status
COMP	Completed (COMP)
